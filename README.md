...
В настоящий момент весь опубликованный контент принадлежит автору проекта, защищен авторским правом и может использоваться только с указанием авторства.
В будущем планируется добавить функции, связанные с пользовательским контентом.
